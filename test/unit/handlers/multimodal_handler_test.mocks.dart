...
// in gemini_dart/test/unit/handlers/multimodal_handler_test.dart.
...
import 'package:gemini_dart/src/services/http_service.dart' as _i2;
...
class MockHttpService extends _i1.Mock implements _i2.HttpService {
  ...
  @override
  _i3.Stream<Map<String, dynamic>> postStream(
    String? endpoint, {
    Map<String, dynamic>? body,
    Map<String, String>? queryParameters,
    Map<String, String>? headers,
